...
#'
fit_poisson <- function(count_data, time_data, by_factor = NULL, cooks_constant = 4, return_plot = FALSE){
  ...
  outliers_poisson = which(cooksD > cooks_constant*mean(cooksD))
